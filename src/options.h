...
//==============================================================================
// Option byte registers (memory-mapped I/O)

#define CH32_OPTB_ADDR  0x1FFFF800
#define CH32_OPTB_SIZE  0x40

//------------------------------------------------------------------------------

#define OPTB_USER  CH32_OPTB_ADDR
...
#define OPTB_DATA  (CH32_OPTB_ADDR + 0x04)
...
#define OPTB_WRPR1  (CH32_OPTB_ADDR + 0x08)
...
#define OPTB_WRPR2  (CH32_OPTB_ADDR + 0x0C)
